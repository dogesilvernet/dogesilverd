...
import (
	...
	"github.com/dogesilvernet/dogesilverd/stability-tests/common/mine"
...
func setupSyncee() (*rpc.Client, func(), error) {
	...
	synceeDataDir, err := useDirOrCreateTemp(activeConfig().SynceeDataDirectory, "syncee-dogesilver-data-dir")
	if err != nil {
		return nil, nil, err
	}
...
func setupSyncer() (*rpc.Client, func(), error) {
	...
	syncerDataDir, err := useDirOrCreateTemp(activeConfig().SyncerDataDirectory, "syncer-dogesilver-data-dir")
	if err != nil {
		return nil, nil, err
	}
