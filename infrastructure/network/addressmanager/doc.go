/*
Package addressmanager implements concurrency safe Dogesilver address manager.

# Address Manager Overview

In order maintain the peer-to-peer Dogesilver network, there needs to be a source
of addresses to connect to as nodes come and go. The Dogesilver protocol provides
