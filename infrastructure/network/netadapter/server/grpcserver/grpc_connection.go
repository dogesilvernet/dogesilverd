...
import (
	...
	"github.com/dogesilvernet/dogesilverd/infrastructure/network/netadapter/server"
...
type grpcStream interface {
	Send(*protowire.DogesilverdMessage) error
	Recv() (*protowire.DogesilverdMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.DogesilverdMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.DogesilverdMessage) error {
