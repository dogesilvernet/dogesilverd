...
type P2P_MessageStreamClient interface {
	Send(*DogesilverdMessage) error
	Recv() (*DogesilverdMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *DogesilverdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*DogesilverdMessage, error) {
	m := new(DogesilverdMessage)
...
func (x *p2PMessageStreamServer) Send(m *DogesilverdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*DogesilverdMessage, error) {
	m := new(DogesilverdMessage)
...
func (x *rPCMessageStreamClient) Send(m *DogesilverdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*DogesilverdMessage, error) {
	m := new(DogesilverdMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *DogesilverdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*DogesilverdMessage, error) {
	m := new(DogesilverdMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
