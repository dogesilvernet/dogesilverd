...
func (x *DogesilverdMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "DogesilverdMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *DogesilverdMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
