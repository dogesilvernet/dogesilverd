...
import (
	...
	"github.com/dogesilvernet/dogesilverd/util/mstime"
	"github.com/pkg/errors"
)

func (x *DogesilverdMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "DogesilverdMessage_Version is nil")
	}
...
func (x *DogesilverdMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
