...
func (x *DogesilverdMessage_Reject) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "DogesilverdMessage_Reject is nil")
	}
...
func (x *DogesilverdMessage_Reject) fromAppMessage(msgReject *appmessage.MsgReject) error {
