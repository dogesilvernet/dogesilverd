...
func (x *DogesilverdMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "DogesilverdMessage_RequestPruningPointUTXOSet is nil")
	}
...
func (x *DogesilverdMessage_RequestPruningPointUTXOSet) fromAppMessage(
