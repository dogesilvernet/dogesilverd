...
func (x *DogesilverdMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "DogesilverdMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *DogesilverdMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
