...
func (x *DogesilverdMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "DogesilverdMessage_Addresses is nil")
	}
...
func (x *DogesilverdMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
