...
type GetBlockTemplateRequestMessage struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Which dogesilver address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether dogesilverd thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when dogesilverd is not synced.
	// That is because when dogesilverd isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this dogesilverd initiated the connection
	...
	// The timestamp of when this peer connected to this dogesilverd
