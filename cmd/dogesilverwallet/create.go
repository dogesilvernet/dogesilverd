...
import (
	...
	"github.com/dogesilvernet/dogesilverd/cmd/dogesilverwallet/libdogesilverwallet/bip32"
...
func create(conf *createConfig) error {
	...
	fmt.Printf("Notice the above is neither a secret key to your wallet " +
		"(use \"dogesilverwallet dump-unencrypted-data\" to see a secret seed phrase) " +
		"nor a wallet public address (use \"dogesilverwallet new-address\" to create and see one)\n\n")
	...
	if len(signerExtendedPublicKeys) > 0 {
		cosignerIndex, err = libdogesilverwallet.MinimumCosignerIndex(signerExtendedPublicKeys, extendedPublicKeys)
		if err != nil {
			return err
		}
	}
