...
func parseCommand(args []string, commandDescs []*commandDescription) (*protowire.DogesilverdMessage, error) {
	...
	return generateDogesilverdMessage(commandValue, commandDesc)
}
