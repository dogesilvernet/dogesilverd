...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a dogesilver
...
// NewMsgDoneBlocksWithTrustedData returns a new dogesilver DoneBlocksWithTrustedData message that conforms to the
// Message interface.
