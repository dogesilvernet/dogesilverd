...
// MsgTransactionNotFound defines a dogesilver TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new dogesilver transactionsnotfound message that conforms to the
