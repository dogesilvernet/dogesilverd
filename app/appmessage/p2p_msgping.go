...
// MsgPing implements the Message interface and represents a dogesilver ping
// message.
//
...
// NewMsgPing returns a new dogesilver ping message that conforms to the Message
