...
// MsgInvRelayBlock implements the Message interface and represents a dogesilver
...
// NewMsgInvBlock returns a new dogesilver invrelblk message that conforms to
