...
// MsgDoneHeaders implements the Message interface and represents a dogesilver
...
// NewMsgDoneHeaders returns a new dogesilver DoneIBDBlocks message that conforms to the
// Message interface.
