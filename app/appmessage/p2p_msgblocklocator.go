...
// MsgBlockLocator implements the Message interface and represents a dogesilver
...
// NewMsgBlockLocator returns a new dogesilver locator message that conforms to
