...
// MsgRequestTransactions implements the Message interface and represents a dogesilver
...
// NewMsgRequestTransactions returns a new dogesilver RequestTransactions message that conforms to
