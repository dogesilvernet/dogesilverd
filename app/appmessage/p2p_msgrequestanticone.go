...
// MsgRequestAnticone implements the Message interface and represents a dogesilver
...
// NewMsgRequestAnticone returns a new dogesilver RequestPastDiff message that conforms to the
