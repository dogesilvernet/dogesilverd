...
var DefaultUserAgent = fmt.Sprintf("/dogesilverd:%s/", version.Version())

// MsgVersion implements the Message interface and represents a dogesilver version
...
// NewMsgVersion returns a new dogesilver version message that conforms to the
