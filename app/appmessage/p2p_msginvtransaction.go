...
// MsgInvTransaction implements the Message interface and represents a dogesilver
...
// NewMsgInvTransaction returns a new dogesilver TxInv message that conforms to
