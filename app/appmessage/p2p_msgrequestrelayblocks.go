...
// MsgRequestRelayBlocks implements the Message interface and represents a dogesilver
...
// NewMsgRequestRelayBlocks returns a new dogesilver RequestRelayBlocks message that conforms to
