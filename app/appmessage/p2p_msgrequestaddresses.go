...
// MsgRequestAddresses implements the Message interface and represents a dogesilver
...
// NewMsgRequestAddresses returns a new dogesilver RequestAddresses message that conforms to the
