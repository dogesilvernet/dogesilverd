...
// dogesilver Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a dogesilver
// Addresses message.
...
// NewMsgAddresses returns a new dogesilver Addresses message that conforms to the
