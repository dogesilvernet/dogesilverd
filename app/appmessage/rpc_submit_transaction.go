...
// RPCTransaction is a dogesilverd transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a dogesilverd transaction input representation
...
// RPCScriptPublicKey is a dogesilverd ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a dogesilverd transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a dogesilverd outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a dogesilverd utxo entry representation meant to be used
// over RPC
