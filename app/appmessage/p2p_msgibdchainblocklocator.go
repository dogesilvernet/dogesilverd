...
// MsgIBDChainBlockLocator implements the Message interface and represents a dogesilver
...
// NewMsgIBDChainBlockLocator returns a new dogesilver locator message that conforms to
