...
// MsgRequestNextPruningPointAndItsAnticoneBlocks implements the Message interface and represents a dogesilver
...
// NewMsgRequestNextPruningPointAndItsAnticoneBlocks returns a new dogesilver RequestNextPruningPointAndItsAnticoneBlocks message that conforms to the
// Message interface.
