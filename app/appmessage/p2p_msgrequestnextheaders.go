...
// MsgRequestNextHeaders implements the Message interface and represents a dogesilver
...
// NewMsgRequestNextHeaders returns a new dogesilver RequestNextHeaders message that conforms to the
// Message interface.
