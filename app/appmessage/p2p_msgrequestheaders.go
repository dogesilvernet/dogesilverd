...
// MsgRequestHeaders implements the Message interface and represents a dogesilver
...
// NewMsgRequstHeaders returns a new dogesilver RequestHeaders message that conforms to the
