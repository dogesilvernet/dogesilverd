...
func generateTxs() (nativeTx, subnetworkTx *externalapi.DomainTransaction, err error) {
	...
	address1, err := util.DecodeAddress(address1Str, util.Bech32PrefixDogesilverSim)
	if err != nil {
	...
	address2, err := util.DecodeAddress(address2Str, util.Bech32PrefixDogesilverSim)
	if err != nil {
...
func getSourceScript(b *testing.B) *externalapi.ScriptPublicKey {
	sourceAddressStr := "dogesilversim:qz6f9z6l3x4v3lf9mgf0t934th4nx5kgzu663x9yjh"

	sourceAddress, err := util.DecodeAddress(sourceAddressStr, util.Bech32PrefixDogesilverSim)
	if err != nil {
