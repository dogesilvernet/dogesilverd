/*
Package txscript implements the Dogesilvera transaction script language.

This package provides data structures and functions to parse and execute
Dogesilvera transaction scripts.

# Script Overview

Dogesilvera transaction scripts are written in a stack-base, FORTH-like language.

The Dogesilvera script language consists of a number of opcodes which fall into
...
Typical Dogesilvera scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend Dogesilvera.
