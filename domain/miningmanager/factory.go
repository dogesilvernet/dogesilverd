...
import (
	...
	"github.com/dogesilvernet/dogesilverd/domain/miningmanager/blocktemplatebuilder"
	mempoolpkg "github.com/dogesilvernet/dogesilverd/domain/miningmanager/mempool"
	"sync"
	"time"
)
