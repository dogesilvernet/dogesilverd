...
import (
	...
	"github.com/dogesilvernet/dogesilverd/domain/consensusreference"
	"github.com/dogesilvernet/dogesilverd/domain/miningmanager/model"
	...
	"github.com/dogesilvernet/dogesilverd/domain/miningmanager"
...
func generateNewCoinbase(addressPrefix util.Bech32Prefix, op opType) (*externalapi.DomainCoinbaseData, error) {
	...
	_, publicKey, err := libdogesilverwallet.CreateKeyPair(op == opECDSA)
	if err != nil {
		return nil, err
	}
	var address string
