...
const (
	...
	defaultSubsidyGenesisReward                    = 1 * constants.SompiPerDogesilver
	defaultPreDeflationaryPhaseBaseSubsidy         = 500 * constants.SompiPerDogesilver
	defaultDeflationaryPhaseBaseSubsidy            = 440 * constants.SompiPerDogesilver
