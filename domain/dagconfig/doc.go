...
In addition to the main Dogesilver network, which is intended for the transfer
...
If an application does not use one of the standard Dogesilver networks, a new
