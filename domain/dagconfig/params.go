...
import (
	...
	"github.com/dogesilvernet/dogesilverd/util/network"
...
// Params defines a Dogesilver network by its parameters. These parameters may be
// used by Dogesilver applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// Further details: https://hashdag.medium.com/dogesilver-launch-plan-9a63f4d754a6
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/dogesilvernet/research/issues/3
...
// MainnetParams defines the network parameters for the main Dogesilver network.
var MainnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "dogesilver-mainnet",
	...
	Prefix: util.Bech32PrefixDogesilver,
...
// TestnetParams defines the network parameters for the test Dogesilver network.
var TestnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "dogesilver-testnet-10",
	...
	DNSSeeds: []string{
		...
		"seeder1-testnet.dogesilverd.net",
	},
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixDogesilverTest,
...
// SimnetParams defines the network parameters for the simulation test Dogesilver
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixDogesilverSim,
...
// DevnetParams defines the network parameters for the development Dogesilver network.
var DevnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "dogesilver-devnet",
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixDogesilverDev,
...
// ErrDuplicateNet describes an error where the parameters for a Dogesilver
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Dogesilver network")

var registeredNets = make(map[appmessage.DogesilverNet]struct{})

// Register registers the network parameters for a Dogesilver network. This may
